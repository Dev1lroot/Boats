...
package com.dev1lroot.mcmods.boats.client.screen;
...
public class FurnaceBoatScreen extends AbstractFurnaceScreen<FurnaceBoatMenu> {
    ...
    public FurnaceBoatScreen(FurnaceBoatMenu menu, Inventory inventory, Component title) {
        super(menu, inventory, title, FILTER_NAME, TEXTURE,
            LIT_PROGRESS_SPRITE, BURN_PROGRESS_SPRITE, TABS);
    }
}
